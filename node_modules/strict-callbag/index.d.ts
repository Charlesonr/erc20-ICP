 ...
 */
export type Talkback<E = never> = (signal: Signal.DATA | Signal.END, error?: E | undefined) => void;
type SinkArgs<A, EI, EO> = [signal: Signal.START, talkback: Talkback<EO>] | [signal: Signal.DATA, data: A] | [signal: Signal.END, error: EI | undefined];
/**
 ...
 */
export type Sink<A, EI = unknown, EO = never> = (...op: SinkArgs<A, EI, EO>) => void;
/**
 ...
 */
export type Source<A, E = unknown> = (signal: Signal.START, sink: Sink<A, E, any>) => void;
export {};
